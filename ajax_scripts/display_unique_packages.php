<?php  require_once('../includes/instantiated_files3.php');
       ...
       $cid = $_POST['catid'];
       //$getpack_se = $object->get_rows_from_one_table_by_id('package_definition','visibility',1);
       $getpack_se = $object->get_rows_from_one_table_by_two_params('package_definition','visibility',1,'package_category',$cid);


    
       if($getpack_se == null){
           echo "<h2 style='text-align:center;color:white;'>No Packages Found.</h2>";
       }else{
           
              $count = 1;
              //var_dump($getpack);
              foreach($getpack_se as $pack){ 
                      ...
                      <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            <div><strong>Package Description:</strong></div>
                                ...
                                <input  id="<?php echo $pack['unique_id']; ?>" type="submit" name="cmd_subscribe_pack"  value="Subscribe to Package" class="btn btn-lg btn-success cmd_subscribe_pack333" >
   ...
   <script type="text/javascript">
    // In your Javascript (external .js resource or <script> tag)
        ...
        //$('#display_packages').empty();
         ...
         $('.cmd_subscribe_pack333').click(function(e){
