...
$get_rows = $object->get_rows_from_one_table_by_id('subscribed_user_tbl','user_id',$uid);
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row" style="margin-top: -160px;">
        ...
        <div class="modal-body">
             <?php
                  $invested_amount = $value['amount_paid'];
             ...
             <div class="row">
                  <div class="col-md-12">
                       ...
                       <span style="font-size: 15px;"><i class="fa fa-money-check text-primary"></i></span> Total Profits: <?php echo '&#8358;'.number_format($total_roi,2); ?><br>
                       <span style="font-size: 15px;"><i class="fa fa-money-bill text-purple"></i></span> Total Investment Plus Profit: <?php echo '&#8358;'.number_format($invested_amount_plus_interest,2); 
             ...
             <?php for($i = 1; $i <= $value['duration']; $i++){ 
                  $next_month_loop  = date('d-m-Y', strtotime('+'.$i.' month', strtotime($value['date_created'])));


                 $added_profit = $added_profit + $interest_amount_per_month;
                 
                 if( strtotime($next_month_loop) < strtotime($current_date) ){
                      if(   (number_format((strtotime($next_month_loop) - strtotime($value['date_created']))/(60*60*24*30),0))   % $getpackage['withdrawable_month'] == 0 ) { 
           ...
           ?>
                ...
                <div class="row">
                        <div class="col-md-12">
                            <span data-toggle="tooltip" title="Profit means the total profit at the end the investment">Profit Accrued: &#8358;<strong><?php echo number_format($added_profit,2); ?></strong></span><br>
                            <span data-toggle="tooltip" title="Withdrawable Profit means profit due for withdrawal into your wallet">Withdrawable Profit: &#8358;<strong><?php echo number_format($withdrawable_profit,2); ?></strong><br><br>
                              <!-- Profit Balance: &#8358;<strong><?php //echo number_format($get_profits_per_package_decode['actual_withdrawable_profit'],2); ?> --></strong><br>
