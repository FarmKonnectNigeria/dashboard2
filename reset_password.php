        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-3">
            ...
            <div class="card-body px-lg-3 py-lg-5">
              <form role="form" id="reset_password_form" method="post" action="">
                ...
                <div class="form-group mb-3">
                 ...
                 <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    <input class="form-control" id="unique_id" name="unique_id" type="hidden" value="<?php echo $_GET['id'];?>">
                  </div>
                </div>
                <div class="text-center">
                  <button type='button' class="btn btn-success btn-lg btn-block" id="reset_password">Reset Password</button>
                </div>
              </form>
            </div>
          </div>
