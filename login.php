        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-3">
            ...
            <div class="card-body px-lg-3 py-lg-5">
              ...
              <form id="login_form" action="post" role="form">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                    </div>
                    <input class="form-control" placeholder="Email or Phone Number" id="email_or_phone" name="email_or_phone" type="email">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <a href="#" id="login" name="login" class="btn float-right btn-success">Login</a> 
          ...
          <div class="row mt-3">
            <div class="col-6">
              <!-- forgot_password --> <a href="forgot_password"><small>Forgot Password</small></a>
            </div>
