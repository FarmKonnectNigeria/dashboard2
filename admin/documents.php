...
$created_by = $_SESSION['adminid'];
 ...
 $get_documents = $object->get_rows_from_table_by_user_id('admin_document_tbl','user_id',$created_by);
?>
<body class="">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                        ...
                        <td><a href="<?php echo $value['image_url']?>" class="thumbnail fancybox" rel="ligthbox"><?php echo $value['image_url']?></a></td>
                         ...
                         <div class="modal fade" id="delete<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                   <form method="post" id="delete_document_form<?php echo $value['unique_id']; ?>">
                                     <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                  </form> 
                                  <button class="btn btn-success delete_document" id="<?php echo $value['unique_id']; ?>">Yes</button>
