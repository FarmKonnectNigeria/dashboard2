...
<body class="">
  <?php include('includes/sidebar.php'); 
     if($role_name != 'Lead Officer' && $role_name != 'Business Executive'){
                      ...
                      <div class="row">
                            <div class="col-lg-12">
                                 <label class="form-control-label" for="input-first-name">Location and Source of Lead</label>
                                  ...
                                  <br><br>
                                  <div class="row">
                                    <div id="others" class="col-lg-12" style="display: none;">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                   <label class="form-control-label" for="input-first-name">Add Social Media handles (if exists)</label>
                               <input type="text" name="social_media" id="social_media"  class="form-control" placeholder="Separate with comma">
                              </div>
                            </div><br>
                            <div class="row">
                            <div class="col-lg-12">
...
<script type="text/javascript">
  $(document).ready(function(){
    $("select#location_source").change(function(){
      ...
      else if(location == 'Uber'){
        $('#others').css("display", "none");
      }
      else if(location == 'Taxify'){
        $('#others').css("display", "none");
      }
      else if(location == 'Direct Marketing'){
        $('#others').css("display", "none");
      }
    });
});
