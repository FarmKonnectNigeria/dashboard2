        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <h3 class="mb-0">Backdate a Customer's Investment(FIXED)</h3>
            </div>
                    ...
                    <div class="col-lg-8">
                      ...
                      <!-- <div class="form-group"> -->
                        ...
                        <select name="user_id" id="user_id" class="form-control select-2">
                            ...
                            <option value="<?php echo $users['unique_id']; ?>"><?php echo $users['other_names'].' '.$users['surname'].' ('.$users['email'].')'; ?></option>
                            <?php } ?>
...
<script type="text/javascript">
    ...
    $('#user_id').change(function(e){
        ...
        var userid = $(this).val();
          ...
          $.ajax({
            url:"ajax_admin/get_investment_to_backdate.php",
            method:"POST",
            data:{userid:userid},
                        beforeSend: function(){
    ...
    $('#cmd_backdate_investment_request').click(function(e){
        ...
        $.ajax({
        url:"ajax_admin/send_investment_backdate_request.php",
        method:"POST",
        ...
        $("#spinner_classb").empty();
        	if(data == "success"){
						   ...
						   setTimeout( function(){ window.location.href = "backdate_investment";}, 7000);
				}
