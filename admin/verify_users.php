        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of Unverified Users</h3>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                   ...
                   foreach($get_rows as $value){
                    ...
                    $get_document = $object->get_one_row_from_one_table('document_tbl', 'user_id', $value['unique_id']);
                    $nok_surname = $value['nok_surname'];
                    $nok_name = $value['nok_name'];
                    $nok_phone = $value['phone'];
                    $nok_email = $value['email'];
                    $bank_name = $value['bank_name'];
                    $account_name = $value['account_name'];
                    $account_number = $value['account_number'];
                    $bvn = $value['bvn'];
                    $account_type = $value['account_type'];
                    if($nok_surname != '' AND $nok_name != '' AND $nok_phone != '' AND $nok_email != '' AND $bank_name != '' AND $account_name != '' AND $account_number != 0 AND $bvn != '' AND $account_type != '' AND $value['verification_status'] == 0) {
                     ?>
                     <tr>
                        ...
                        <td> 
                          ...
                          <span id="verify_user_modal<?php echo $value['unique_id']; ?>"><small class="btn btn-sm btn-success" data-toggle="modal" data-target="#verify_user<?php echo $value['id']; ?>">Verify User</small></span>
                        ...
                        <div class="modal fade bd-example-modal-md" id="view<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <!--<div><strong>Submitted Document: </strong><a href="<?php //echo "../".$get_document['image_url']?>" class="thumbnail fancybox" rel="ligthbox"><?php //echo $get_document['document_name']?><small> (Click to view)</small></a>-->
                                  <!--</div>-->
                          ...
                          <div class="modal fade bd-example-modal-md verify_modal" id="verify_user<?php echo $value['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
