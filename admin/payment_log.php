...
$get_rows = $object->get_rows_from_one_table_by_two_params('client_payment_log','admin_id', $uid, 'payment_status', 2);
//print_r($get_rows);
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of all the Payment made by your Clients</h3> 
            </div>
