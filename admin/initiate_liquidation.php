        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <h3 class="mb-0">Initiate Liquidation for Customer's Investment</h3>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-8">
                      <form  method="post" id="initiate_liquidation_form"> 
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure you want to initiate liquidation for this investment? Please Confirm
      </div>
      <div class="modal-footer">
        <button class="btn btn-danger initiate_liquidation" id="initiate_liquidation" type="button">Initiate Liquidation</button>
...
<script type="text/javascript">
    ...
    $('#user_id').change(function(e){
        ...
        var userid = $(this).val();        
        	$.ajax({
						url:"ajax_admin/get_investment_details.php",
						method:"POST",
						data:{userid:userid},
						 beforeSend: function(){
