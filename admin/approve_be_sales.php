...
$get_rows = $object->get_rows_from_one_table_by_id('be_sales','sales_status', 2);
                      ...
                      <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  Are you sure you want to approve this Sale?
                                      <form method="post" id="approve_be_sales_form<?php echo $value['unique_id']; ?>">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-success approve_be_sales" id="<?php echo $value['unique_id']; ?>">Approve</button>
