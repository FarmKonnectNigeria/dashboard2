...
// $param1 = 'user_id';
$get_bonus_claim = $object->get_bonus_claim('be_sales','commission_status',1, 'commission_status', 4);
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of pending Commission Claim</h3>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                   ...
                   foreach($get_bonus_claim as $value){
                    ...
                    $get_user = $object->get_one_row_from_one_table('admin_tbl','unique_id',$value['added_by']);
                    ...
                    @$commission = ($percentage_commission / 100) * ($value['amount']);
                     ...
                     <tr>
                        ...
                        <td><?php if($value['commission_status'] == 1){?>
                      ...
                      <?php }?>
                        ...
                        <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success approve_commission_claim" name="approve_commission_claim" id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="approve_commission_claim_form<?php echo $value['unique_id']; ?>">
                                    ...
                                    <input type="hidden" class="form-control" id="commission" name="commission" value="<?php echo $commission?>">
                                </form>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="modal fade bd-example-modal-md" id="reject<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-danger reject_commission_claim" name="reject_commission_claim" id="<?php echo $value['unique_id']; ?>">Reject</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="reject_commission_claim_form<?php echo $value['unique_id']; ?>">
                                    <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                    <input type="hidden" class="form-control" id="BE_id" name="BE_id" value="<?php echo $value['added_by']?>">
                                    <input type="hidden" class="form-control" id="commission" name="commission" value="<?php echo $commission?>">
                                </form>
                        ...
                        <div class="modal fade bd-example-modal-md" id="query<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-info query_commission_claim" name="query_commission_claim" id="<?php echo $value['unique_id']; ?>">Query</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="query_commission_claim_form<?php echo $value['unique_id']; ?>">
                                    <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                    <input type="hidden" class="form-control" id="BE_id" name="BE_id" value="<?php echo $value['added_by']?>">
                                    <input type="hidden" class="form-control" id="commission" name="commission" value="<?php echo $commission?>">
                                </form>
