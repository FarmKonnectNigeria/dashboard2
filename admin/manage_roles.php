                ...
                <tbody>
                   ...
                   foreach($get_rows as $value){
                     ...
                     <tr>
                      ...
                      <?php } else{?>
                          <small class="btn btn-sm btn-success" data-toggle="modal" data-target="#edit<?php echo $value['id']; ?>">Reassign Functions/Pages</small>
                          <small class="btn btn-sm btn-danger"data-toggle="modal" data-target="#archive<?php echo $value['id']; ?>">Archive Role</small>
                        <?php } }else{
                          echo "<div class='badge badge-danger'>No edit access</div>";
                        }?>
                        </td>
                      </tr>
                 ...
                 <div class="modal fade" id="edit<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"aria-hidden="true">
                            ...
                            <div class="col-lg-12"> 
                             ...
                             <label class="form-control-label" for="input-first-name">Functions to be performed</label><br>
                                  ...
                                  <label class="form-control-label" for="input-first-name">Pages to be accessed</label><br>
                                  <select class="col-lg-12" name="pages[]" multiple="multiple">
                                      <!-- <option value="Select Functions">Select Functions</option> -->
                                      <?php 
                                        foreach($get_pages as $val){
                                      ?>
                                      <option value="<?php echo $val['unique_id']; ?>"><?php echo $val['page_name']; ?></option>
                                    <?php } ?>
