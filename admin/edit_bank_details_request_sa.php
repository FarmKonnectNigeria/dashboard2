                   ...
                   foreach($get_request as $value){
                    ...
                    $get_user = $object->get_one_row_from_one_table('users_tbl','unique_id',$value['user_id']);
                     ...
                     <tr>
                        ...
                        <?php //if($found > 0){?>
                        <td> <span id="approve_edit_bank_modal<?php echo $value['unique_id']; ?>"><small class="btn btn-sm btn-success" data-toggle="modal" data-target="#approve<?php echo $value['id']; ?>">Approve</small></span>
                        </td>
                        <?php //} ?>
                        ...
                        <div class="modal fade bd-example-modal-md approve_modal" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success approve_change_bank_details_sa " name="approve_change_bank_details_sa " id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="approve_change_bank_details_sa_form<?php echo $value['unique_id']; ?>">
