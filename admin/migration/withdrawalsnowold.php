...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<a href="index.php">Back to Home</a> | <a href="view_withdrawals.php">View Client's Withdrawals</a>  
				<h3><strong>Withdrawals(Wallet to Bank Account):<br> <span style="font-size: 14px;">This is just logging withdrawals</span> </strong> </h3>
				<form method="post">
