...
$get_rows = $object->get_rows_from_table_by_user_id('users_tbl', 'access_level', 0);;
...
if(isset($_POST['cmd_submit'])){
	...
	$amount = $_POST['amount'];
	$insert = $object->insert_deposits_unactivated($user_id,$amount,$payment_method,$deposit_date,'11', $description);
...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<a href="index.php">Back to Home</a> | <a href="view_deposits.php">View Client's Deposits</a>|  <a href="deposits.php">Add deposit for activated users</a>  
