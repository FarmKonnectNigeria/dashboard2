...
// $param1 = 'user_id';
$get_request = get_recurrent_backdated_investments('backdate_investment_maker_checker'); 
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                 <?php if($get_request == null){
                  ...
                  <tr>
                        ...
                        <th scope="col">Total Contribution(days)</th>
                ...
                <tbody>
                   ...
                   $total_amount_per_contribution = $get_investment['total_amount'];
                     ?>
                     <tr>
                        ...
                        <td><?php echo  number_format($value['contributory_days']) .' days' ;?></td>
                        <td>&#8358;<?php echo  number_format(  $total_amount_per_contribution * $value['contributory_days']  ) ;?></td>
                        ...
                        <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success accountant_approve_backdate_rec" name="accountant_approve_backdate_rec" id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="accountant_approve_backdate_rec_form<?php echo $value['unique_id']; ?>">
                                    ...
                                    <input type="hidden" class="form-control" id="contributory_days" name="contributory_days" value="<?php echo $value['contributory_days']?>">
                                </form>
                            </div>
                          </div>
                        </div>
                        <div class="modal fade bd-example-modal-md" id="undo<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success accountant_undo_backdate_rec" name="accountant_undo_backdate_rec" id="<?php echo $value['unique_id']; ?>">Undo</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="accountant_undo_backdate_rec_form<?php echo $value['unique_id']; ?>">
                                    <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                    <input type="hidden" class="form-control" id="investment_id" name="investment_id" value="<?php echo $value['investment_id']?>">
                        ...
                        <div class="modal fade bd-example-modal-md" id="reject<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-danger acct_reject_backdated_rec" name="acct_reject_backdated_rec" id="<?php echo $value['unique_id']; ?>">Reject</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="acct_reject_backdated_rec_form<?php echo $value['unique_id']; ?>">
                                    <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                    <input type="hidden" class="form-control" id="investment_id" name="investment_id" value="<?php echo $value['investment_id']?>">
                                </form>
                            </div>
