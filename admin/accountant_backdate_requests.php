...
// $param1 = 'user_id';
$get_request = $object->get_rows_from_one_table_by_id('backdate_investment_maker_checker','status', 2); 
                     ...
                     <tr>
                        ...
                        <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success accountant_approve_backdate" name="accountant_approve_backdate" id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                        ...
                        <div class="modal fade bd-example-modal-md" id="reject<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-danger accountant_reject_backdate" name="accountant_reject_backdate" id="<?php echo $value['unique_id']; ?>">Reject</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
