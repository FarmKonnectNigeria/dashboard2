                     ...
                     <tr>
                        ...
                        <td> 
                          ...
                          if($value['status'] == 1){
                            ...
                            echo '<small class="badge badge-success">Approved by SA</small>';
                          } 
                        ...
                        <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success approve_backdate_MM" name="approve_backdate_MM" id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="approve_backdate_MM_form<?php echo $value['unique_id']; ?>">
