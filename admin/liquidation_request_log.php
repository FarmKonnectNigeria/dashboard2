...
$get_request = $object->get_rows_from_one_table_by_one_param('liquidated_investments_tbl','process_status',2);
...
<body class="">
  <?php include('includes/sidebar.php'); 
     if($role_name != 'Cash Officer' && $role_name != 'CRM'){
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of Processed Liquidation Requests</h3>
            </div>
                   ...
                   foreach($get_request as $value){
                    ...
                    $get_package = $object->get_one_row_from_one_table('package_definition','unique_id',$get_investment['package_id']);
                     ...
                     <tr>
                        ...
                        <td><small class="badge badge-success">Processed</small></td>


                        <?php //if($found > 0){?>
                        <td> <small class="btn btn-sm btn-primary" data-toggle="modal" data-target="#view<?php echo $value['id']; ?>">View Investment Details</small></td>
                        <?php //} ?>
