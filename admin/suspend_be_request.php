...
$param1 = 'user_id';
$get_rows = $object->get_rows_from_one_table('be_suspension_tbl');
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of all Business Executive Suspension Request</h3>
            </div>
              ...
              <table class="table align-items-center table-flush">
                 ...
                 <?php if($get_rows == null){
                  ...
                  <tr>
                       ...
                       <!--  <th scope="col">Rating</th> -->
                        ...
                        <th scope="col">Time Frame for Suspension</th>
                ...
                <tbody>
                   ...
                   foreach($get_rows as $value){
                      $get_be = $object->get_one_row_from_one_table('admin_tbl','unique_id', $value['BE_id']); 
                      $get_be_sales = $object->get_one_row_from_one_table('be_target','BE_id', $value['BE_id']);  
                      $get_be_status = $object->get_one_row_from_one_table('business_executive_tbl','unique_id', $value['BE_id']);
                     ?>
                     <tr>
                        ...
                        <td><?php echo $value['time_frame'].' days';?></td>
                        ...
                        <td>
                          <?php
                          if($get_be_status['status'] == 4){
                            ?>
                          <span id="approve_suspend_modal<?php echo $value['unique_id']; ?>"><small class="btn btn-sm btn-danger" data-toggle="modal" data-target="#sack<?php echo $value['id']; ?>">Approve Request</small></span>
                        <?php } ?>
                        </td>
                        ...
                        <div class="modal fade bd-example-modal-md approve_modal" id="sack<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                ...
                                Are you sure you want to approve the request to suspend this Business Executive?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-danger approve_suspend_request" name="approve_suspend_request" id="<?php echo $value['unique_id']; ?>" > Suspend </button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                  <form method="post" id="approve_suspend_request_form<?php echo $value['unique_id']; ?>">
                                    <input type="hidden" class="form-control" id="unique_id" name="unique_id" value="<?php echo $value['unique_id']?>">
                                    <input type="hidden" class="form-control" id="BE_id" name="BE_id" value="<?php echo $value['BE_id']?>">
                                </form>
                                </div>
                            </div>
                          </div>
