...
$get_rows = $object->get_rows_from_one_table_by_id('be_sales','sales_status', 0);
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of Sales made by your Business Executives</h3>
            </div>
                   ...
                   foreach($get_rows as $value){
                    ...
                    if($get_be['assigned_to'] == $uid){
                     ...
                     <tr>
                      ...
                      <?php } else if($value['sales_status'] == 1){
                        ?>
                      ...
                      <div class="modal fade bd-example-modal-md" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  Are you sure you want to approve this Sale?
                                      <form method="post" id="approve_sales_form<?php echo $value['unique_id']; ?>">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-success approve_sales" id="<?php echo $value['unique_id']; ?>">Approve</button>
