...
$get_rows = $object->get_feedback_BE($uid);
//print_r($get_rows);
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of Feedback sent by your Leads, Prospects and Clients</h3> 
            </div>
                            ...
                            <div class="col-lg-12"> 
                             ...
                             <label class="form-control-label" for="input-first-name">Status of Feedback</label><br>
                                  <select class="col-lg-12 form-control" name="status">
                                      <option value="Select Feedback">Select status of Feedback</option>
                                ...
                                <div class="modal-footer">
                                  <button class="btn btn-success get_feedback_id_be" name="update_complaint" id="<?php echo $value['id']; ?>">Update</button>
                                  </form>
