<?php session_start();
    ...
    $notification_heading = 'Transfer Funds';
    $notification = 'Hello, Your transfer of '.$amount_sent. ' to ' .$beneficiary_name. ' failed';
    ...
    $object->insert_into_notifications_tbl($notification_type, $sender_id, $notification_heading, $notification);
}
?>