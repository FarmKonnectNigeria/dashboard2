<?php session_start();
    ...
    $approve_subscription_request_military = $object->approve_subscription_request_military($unique_id);
    $dec = json_decode($approve_subscription_request_military,true);
    if($dec['status'] != 1){
        echo $dec['msg'];
    }else{
        echo 200;
        ...
        $notification = 'Hello, your military package subscription request has been successfully approved';
        $object->insert_logs($_SESSION['adminid'], 'Military Package Subscription Approval');
