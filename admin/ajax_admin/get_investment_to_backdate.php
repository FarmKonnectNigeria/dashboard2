<?php  include('../includes/instantiated_files.php');
      ...
      if($check_subscribed_packages){
          //echo "exists";
          $get_subscribed_packages =  $object->get_rows_from_one_table_by_three_params('subscribed_packages', 'user_id', $userid,'liquidation_status', 0,'package_type',1);
          ...
          echo "<br>Sorry, This Customer does not have a fixed package yet...<br>Use this Link to buy a package for a user: <a href='./buy_package'>Buy Package</a>";
      }
?>
   ...
   //get details for users subscribed packages
    $('#invst_id').change(function(e){
        ...
        if(invst_id == ""){
            ...
            $.ajax({
            url:"ajax_admin/get_a_package_details.php",
            method:"POST",
