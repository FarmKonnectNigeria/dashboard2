...
$form = "<h3><b><u>Term Packages</u></b></h3>";
...
$form .= '<label>Day-Interval to Increase MF</label> : <input class="form-control form-control-sm" type="number" style ="width:50%; margin-bottom:2px;"><br>';
$form .= '<label>Increase MF By</label> : <input class="form-control form-control-sm" type="number" style ="width:50%; margin-bottom:2px;"><br>';
