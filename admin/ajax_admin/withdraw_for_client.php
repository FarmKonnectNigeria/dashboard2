          ...
          $user_id = $_POST['user_id'];
           ...
           if($wallet_balance < $amount_to_withdraw){
              echo 500;
                ...
                $insert_withdrawal_request = $object->insert_wallet_withdrawal_request($user_id,$amount_to_withdraw,$wallet_balance);
                ...
                $notification = 'A Withdrawal Request was placed for you';
                ...
                echo 200;
                 ...
                 $object->insert_users_logs($user_id, 'Requested for withdrawal from Wallet');
