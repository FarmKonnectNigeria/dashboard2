...
$form = "<h3><b><u>Basal Daily Plans</u></b></h3>";
$form .= '<label>Recurrence Value</label> : <input class="form-control form-control-sm" id="pack_slug" name ="pack_slug"  value="basal_daily"  type="hidden"  style ="width:50%; margin-bottom:2px;">
<input class="form-control form-control-sm" id="recurrence_value" name ="recurrence_value"   type="number"  style ="width:50%; margin-bottom:2px;"><input class="form-control form-control-sm" value="1" id="basal_type" name="basal_type"    type="hidden" style ="width:50%; margin-bottom:2px;"><br>';
...
$form .= '<label>Minimum number of slot</label> : <input id="min_no_slots" name="min_no_slots" class="form-control form-control-sm" type="number" style ="width:50%; margin-bottom:2px;"><br>';
