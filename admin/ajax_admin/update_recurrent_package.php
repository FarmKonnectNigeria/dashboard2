<?php  include('../includes/instantiated_files.php');
		...
		$create = $object->update_recurrent_package($package_id,$recurrence_value,$contribution_period,$incubation_period,$recurrence_type,$package_name,$package_category,$package_description,$package_type,$package_unit_price,$min_no_slots,$moratorium,$free_liquidation_period,$liquidation_surcharge,$tenure_of_product,$float_time,$multiplying_factor,$capital_refund,$backdatable,$no_of_slots,$visibility,$package_commission,$uid);
