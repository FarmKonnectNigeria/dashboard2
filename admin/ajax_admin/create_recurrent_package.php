<?php  include('../includes/instantiated_files.php');
		...
		$capital_refund =  str_replace(',','',$_POST['capital_refund']);
		$capital_refund_days =  str_replace(',','',$_POST['capital_refund_days']);
		...
		$create = $object->create_recurrent_package($recurrence_value,$contribution_period,$incubation_period,$recurrence_type,$package_name,$package_category,$package_description,$package_type,$package_unit_price,$min_no_slots,$moratorium,$free_liquidation_period,$liquidation_surcharge,$tenure_of_product,$float_time,$multiplying_factor,$capital_refund,$capital_refund_days,$backdatable,$no_of_slots,$visibility,$package_commission,$uid);
