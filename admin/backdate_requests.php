...
// $param1 = 'user_id';
$get_request = $object->get_rows_from_one_table('backdate_investment_maker_checker'); 
                    ...
                    $get_added_by = $object->get_one_row_from_one_table('admin_tbl','unique_id',$value['added_by']);
                     ...
                     <tr>
                        ...
                        <td> 
                          <?php
                          if($value['status'] == 0){
                            echo '<small class="badge badge-primary">Pending by MM</small>';
                          }
                          if($value['status'] == 1){
                        ...
                        <td> 
                          ...
                          if($value['status'] == 1){
                        //if($found > 0){?>
                          <span id="approve_backdate_modal<?php echo $value['unique_id']; ?>"><small class="btn btn-sm btn-success" data-toggle="modal" data-target="#approve<?php echo $value['id']; ?>">Approve</small></span>
                        </td>
                        <?php } ?>
                        ...
                        <div class="modal fade bd-example-modal-md approve_modal" id="approve<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              ...
                              <div class="modal-footer">
                                   <button type="button" class="btn btn-success approve_backdate" name="approve_backdate" id="<?php echo $value['unique_id']; ?>">Approve</button>
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                </div>
                                <form method="post" id="approve_backdate_form<?php echo $value['unique_id']; ?>">
