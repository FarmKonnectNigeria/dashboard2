...
$get_rows = $object->get_rows_from_one_table_by_id('leads_tbl','created_by',$uid);
$get_rows2 = $object->get_rows_from_one_table_by_id('leads_tbl','created_by',$uid);
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a list of all your Leads<span><button style="margin-left: 13px;" type="button" class="btn btn-success btn-sm float-right mb-10" data-toggle="modal" data-target="#send_msg_modal"><i class="fas fa-plus-circle" ></i> Send Messages to Leads</button>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form  id="send_msg_form" method="post"> 
                        <!-- Default input -->
                        <h1 class="modal-title" id="exampleModalLabel">Send Message to All Leads</h1>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button><br>
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                            <label for="formGroupExampleInput">All Your Leads</label>
                            <p><?php
                              //$emails_array = array();
