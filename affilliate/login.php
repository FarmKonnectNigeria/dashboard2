        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-3">
            ...
            <div class="card-body px-lg-3 py-lg-5">
              ...
              <form id="aff_login_form" action="post" role="form">
                ...
                <div class="text-center">
                  <a href="#" id="aff_login" name="aff_login" class="btn float-right btn-primary">Login</a> 
          ...
          <div class="row mt-3">
            <div class="col-6">
               <a href="forgot_password" name="forgot_password" id="forgot_password"><small>Forgot Password</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="signup" class="text-white"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2019 <a href="https://www.cloudware.com" class="font-weight-bold ml-1 text-light" >Cloudware</a>
            </div>
          </div>
          <div class="col-xl-6">
