                            ...
                            <div class="col-lg-12"> 
                              <label class="form-control-label" for="input-first-name">Category</label>
                                  <select name="category_id" id="category_id" class="form-control">
                                      ...
                                      <option value="standard_packages">Standard Plans(Military, Standard, Student standard, Reduced etc)</option>
                                      <option value="term_packages">Term Investments(Starter and Term package)</option>
                                      <option value="basal_daily">Basal Daily Plans(Basal and Student Plan)</option>
                                      <option value="basal_monthly">Basal Monthly Plans(Corper's Package)</option>
