...
$form .= '<label>Price Per Slot </label>: <input type="number" style ="width:25%; margin-bottom:10px;"><br>';
...
$form .= '<label>Day-Interval to Increase MF</label>: <input type="number" style ="width:25%; margin-bottom:10px;"><br>';
$form .= '<label>Increase MF By:</label>: <input type="number" style ="width:25%; margin-bottom:10px;"><br>';
