...
$get_notifications = $object->get_rows_from_one_table_by_id('notifications_tbl','user_id',$uid);
                     ...
                     ?>
                      <tr>
                       ...
                       <td>
                        ...
                        <td>
                          <span id="unread<?php echo $value['unique_id'];?>">
                            <?php
                            if($value['status'] == 1){
                              ?>
                                <button title="mark as unread" style="font-size:8px" class="btn btn-sm btn-danger mark_as_unread" id="<?php echo $value['unique_id'];?>">
                                  <i class="fa fa-check" ></i>
                                </button>
                            <?php }
                            ?>
                          </span>
                          <button title="delete" style="font-size:8px" class="btn btn-sm btn-warning delete_notification" id="<?php echo $value['unique_id'];?>">
                                <i class="fa fa-trash" ></i>
                          </button>
                          <form method="post" id="mark_as_unread_form<?php echo $value['unique_id'];?>">
