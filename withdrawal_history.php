        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">This is a history of your withdrawals to your bank account<br><span>&nbsp;&nbsp;<small style="color:green;">Total Withdrawn: &#8358;<?php echo number_format($total_withdrawn_decode['msg']); ?></small>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-sm float-right mb-3" data-toggle="modal" data-target="#add_slot_modal"><i class="fas fa-plus-circle"></i>Place a Withdrawal: &#8358;<?php echo number_format($profit_decode['actual_withdrawable_profit']); ?></button></span></h3>
            </div>
