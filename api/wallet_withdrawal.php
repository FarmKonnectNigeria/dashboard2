...
$uid = $_POST['uid'];
$get_verification_status = $object->get_one_row_from_one_table('users_tbl','unique_id', $uid);
//echo $get_verification_status['verification_status'];
...
//echo $get_verification_status['verification_status'];
  if($uid == '' || $amount_to_withdraw == 0 ){
      ...
      else if($get_verification_status['verification_status'] == 0){
          echo json_encode(["status"=>"0", "msg"=>"verification_error"]);
      }
      else{
